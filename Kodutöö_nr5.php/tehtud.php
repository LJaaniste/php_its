...
<body>
     ...
     <div class="container">
      ...
      <nav class="navbar navbar-expand-lg">    
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item"><a class="nav-link active" aria-current="page" style="color: #0000ff" href="tehtud.php">Tehtud tööd</a></li>
      ...
      <div class="container">
      <h1>Tehtud tööd</h1>
      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem cupiditate iusto tenetur incidunt culpa quibusdam facilis vero laudantium officiis, consequuntur praesentium error sint hic. Necessitatibus laboriosam nobis autem velit excepturi.</p>
    </div>
